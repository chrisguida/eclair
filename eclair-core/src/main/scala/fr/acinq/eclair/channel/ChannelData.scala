...
final case class DATA_WAIT_FOR_DUAL_FUNDING_CREATED(channelId: ByteVector32, txBuilder: typed.ActorRef[InteractiveTxBuilder.Command]) extends TransientChannelData
final case class DATA_WAIT_FOR_DUAL_FUNDING_PLACEHOLDER(commitments: Commitments,
                                                        ...
                                                        deferred: Option[FundingLocked]) extends TransientChannelData {
  val channelId: ByteVector32 = commitments.channelId
}
